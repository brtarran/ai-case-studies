...
:::{.column-page}
![](images/caira_with_woman_in_bg.jpg){fig-alt="A photograph of a woman in a white t-shirt holding Camera Intelligence's 'Caira' product with a wide-angle lens. She is looking at the camera back as if focusing on the photo or videography."}
:::
...
**Generative Editing** The product also integrates into cloud-based generative models to enable editing of images using Google’s Nano Banana - for example unwanted elements from a scene using simple voice prompts.
...
:::
::: {.g-col-12 .g-col-sm-3}
![](images/camera_intelligence_vish.webp){fig-alt="Headshot of Vishal Kumar, Camera Intelligence's co-founder, holding one of their Caira units, pointing it at the camera."}
