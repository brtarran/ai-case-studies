...
:::
::: {.g-col-12 .g-col-sm-3}
![](images/icon.png){fig-alt="A PC monitor is on display at a public event, with a demo of 1001 Nights running on the machine. A sign above the monitor provides information about the game and its makers, Yuqian Sun and Ada Eden."}
